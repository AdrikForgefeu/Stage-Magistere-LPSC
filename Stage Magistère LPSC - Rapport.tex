...
L'amplitude résultante de cette distorsion spectrale est le paramètre adimensionnel $y$-Compton \cite{Sunyaev_1972} mesuré dans $\theta$, à une distance angulaire d'un redshift $z$, $d_A(z)$ est
\begin{equation}
...
La pression thermique du milieu intra-amas suit une courbe NFW généralisée quasi universelle (\cite{Nagai_2007}), calibrée sur l'échantillon REXCESS par \cite{Arnaud_2010}
\begin{equation}
